...
OUTPUT_DIR = './L3_product'

# MOD08 variable names
VAR_LOGCOT = 'Cloud_Optical_Thickness_Liquid_Log_Mean'
...
VAR_LOGCOTSTD = 'Cloud_Optical_Thickness_Liquid_Log_Standard_Deviation'
...
def main():
    ...
    while current_date <= end_date:
        ...
        try:
            ...
            # Read 2D variables
            cot_data = 10**(read_and_mask_mod_variable(hdf, VAR_LOGCOT))
            ...
            logcot_std = read_and_mask_mod_variable(hdf, VAR_LOGCOTSTD)
            ...
            df_day = pd.DataFrame({
                ...
                'time': current_date,
                'cf_ret_tot': cf_ret_data.flatten(),
                'cf_mod08': cf.flatten(),
                'cttmin': cttmin.flatten(),
                'cf_ret_liq': cf_ret_liq.flatten(),
                'cot': cot_data.flatten(),
                'cer': cer_data.flatten(),
                'logcot_std': logcot_std.flatten(),
                'sza': sza.flatten(),
